...
if (cmd === "show" && id) {
  ...
  if (item.customerReplyAt) console.log(`customerReplyAt ${item.customerReplyAt}`);
  if (item.doneWhen) {
  ...
  if (item.notedAt) console.log(`notedAt ${item.notedAt}`);
  console.log("message");
