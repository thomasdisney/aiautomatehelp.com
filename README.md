...
Customer support is on the site. Briefs go to a private inbox I operate. Status is looked up on /status with the reference and email. Quotes are posted to that same page. Do not add a personal email, phone, calendar, or founder contact.
...
Do not pipe inbox output to ntfy or commit it.
