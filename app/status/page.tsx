  ...
  return (
    <article className="mx-auto max-w-3xl px-5 py-16">
      ...
      <p className="mt-6 leading-relaxed text-ink/70">
        ...
        confirm the stored test after the handoff. A matching check on this browser keeps the
        reference and the received time, not your email. I will not email it. There is no
        personal inbox, phone, or calendar.
      </p>
      <div className="mt-10">
