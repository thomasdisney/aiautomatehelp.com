...
const ERRORS: Record<string, string> = {
  ...
  intake_not_connected: "Briefs are not being accepted right now. Try again later.",
};
    ...
    return (
      <div className="space-y-4">
        <div className="rounded-2xl border border-ink/10 bg-white p-6 sm:p-8" role="status">
          <p className="text-sm font-medium uppercase tracking-wide text-ink/50">Brief form</p>
          <p className="mt-3 text-lg font-semibold text-ink">Checking…</p>
          <p className="mt-3 leading-relaxed text-ink/70">
            Making sure a brief can be stored here.
          </p>
        </div>
        {saved}
      </div>
    ...
    return (
      <div className="space-y-4">
        <div className="rounded-2xl border border-ink/10 bg-white p-6 sm:p-8">
          ...
          <p className="mt-3 leading-relaxed text-ink/70">
            New briefs are not being accepted right now. If you already sent one, check it on
            the status page.
          </p>
