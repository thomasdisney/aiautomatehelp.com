        ...
        <div className="rounded-2xl border border-ink/10 bg-white p-6 sm:p-8" role="status">
          ...
          <div className="mt-5 flex flex-col gap-3 sm:flex-row">
            <Link
              ...
              className="inline-flex min-h-11 items-center justify-center rounded-full bg-accent px-5 text-sm font-semibold text-ink hover:bg-accent-hover"
            >
              Check status
            </Link>
            ...
            <button
              ...
              className="inline-flex min-h-11 items-center justify-center rounded-full border border-ink/15 px-5 text-sm font-semibold text-ink hover:bg-paper"
            >
              Send another brief
            </button>
          </div>
      ...
      >
        ...
        <div>
          ...
          <input
            ...
            autoComplete="name"
            className="mt-1.5 min-h-11 w-full rounded-lg border border-ink/15 px-3 py-2.5 text-base outline-none focus:border-accent focus:ring-2 focus:ring-accent/30"
          />
        </div>
        <div>
        ...
        <button
          ...
          className="inline-flex min-h-11 w-full items-center justify-center rounded-full bg-accent px-5 py-3 text-sm font-semibold text-white hover:bg-accent-hover disabled:opacity-60"
        >
